...
describe('Dashboard Smoke Test', function () {
    ...
    it('Verification of Profile Tab',async function () {
        await usersPO.clickOnPrfileHeader();
        await usersPO.verificationOfProfileTab();
    });
    
    it('Verification of Profile Tab',async function () {
        await usersPO.clickOnVoiceMailDropTab();
        await usersPO.verificationOfVoiceMailDropTab();
    });
